...
export function getStatusColor(status: string): string {
    const colors: Record<string, string> = {
        ...
        ready_for_chief_approval: 'bg-cyan-500/20 text-cyan-300 border-cyan-500/30',
        approval_request_with_reservations: 'bg-orange-500/20 text-orange-300 border-orange-500/30',
        ready_for_manual_publish: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30',
